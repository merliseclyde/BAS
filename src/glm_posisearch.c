...
SEXP glm_posisearch(SEXP Y, SEXP X, SEXP Rprobinit, SEXP Rmodeldim,  SEXP modelprior, SEXP Rupdate, 
					SEXP Rbestmodel, SEXP Rbestmarg, SEXP plocal, SEXP BURNIN_Iterations, SEXP LAMBDA)
{
	...
	double *Xwork, *Ywork, *coefficients,*probs, shrinkage_m=1.0, *MCMC_probs,
		...
		R2_m, RSquareFull, prone, denom, logmargy=0.0, postold, postnew;
	...
	double one=1.0, zero=0.0, lambda; 
