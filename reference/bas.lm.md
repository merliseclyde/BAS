...
- initprobs:
  ...
  uses[`eplogprob.marg`](http://merliseclyde.github.io/BAS/reference/eplogprob.marg.md)
  function to approximate the Bayes factor from p-values from the full
...
[`plot.bas`](http://merliseclyde.github.io/BAS/reference/plot.md) is
...
[`coefficients.bas`](http://merliseclyde.github.io/BAS/reference/coef.md).
