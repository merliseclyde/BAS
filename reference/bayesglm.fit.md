...
- coefprior:
  ...
  include
  [`bic.prior()`](http://merliseclyde.github.io/BAS/reference/IC.prior.md),` `[`aic.prior()`](http://merliseclyde.github.io/BAS/reference/IC.prior.md),
  and `ic.prior()`
...
[`bic.prior`](http://merliseclyde.github.io/BAS/reference/IC.prior.md)
